...
import { defaultBranch } from "../../checkout.mjs";
import { inTheWay } from "../../run/install.mjs";
import { mergeBaseDiff } from "../../gates/scope.mjs";
...
test("the remote-tracking prefix is spelled in one file under tools, the one that exports the ref", () => {
  const spelled = readdirSync(TOOLS, { recursive: true, withFileTypes: true })
    ...
    // The tests beside the scripts plant the prefix in the refs they build, which is no read of one.
