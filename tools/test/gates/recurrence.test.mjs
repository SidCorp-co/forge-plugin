...
import { bodyFor, markerFor, passMarkerFor, passTitleFor, titleFor } from "../../gates/recurrence.mjs";
import { DEFAULT_OVERLAP_THRESHOLD } from "../../../plugin/hooks/vendor/text-overlap.js";
import { duplicateOf } from "../../../plugin/src/tracker/issue-shape.mjs";
import { fakeTracker, projectRecord, ranAsync, shortPage } from "../../../plugin/test/fixtures.mjs";
import { OWN } from "../../../plugin/test/fixtures/own-project.mjs";

const ROOT = new URL("../../..", import.meta.url).pathname;
const MODULE = new URL("../../gates/recurrence.mjs", import.meta.url).href;
