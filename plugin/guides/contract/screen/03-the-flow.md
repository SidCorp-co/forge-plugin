...
| `reopen` | a finding sent the work back: a person disagreeing with a close or a drop, or the run sent to judge a landed change blocking it before either | 1 Triage, of that finding |
