...
than send the same one again.

**A person's look is a person's**, and this session does not stand in for one. Where the rung before
release waits on somebody seeing the change, what that person is shown is the set the plan named, and
the issue rests there until they have seen it.

An outcome the criteria do not cover is a correction, posted in the open where the run that owns the
change answers it. The criteria being judged are not edited here.
