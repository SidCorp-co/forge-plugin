...
4. **This session judges; it does not build and it does not land.** A finding that blocks sends the
   issue to `reopen`, the status a ranked queue offers back and a park is not, which is a fresh
