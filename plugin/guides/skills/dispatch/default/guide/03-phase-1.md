...
**Where this project declared the judgement an independent run's, the same output carries a second
kind of candidate, listed apart from the ones it scores**: the issues a judging run claims from.
