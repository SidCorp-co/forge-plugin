...
up on this machine: `references/setup.md`.
...
labels drifted. What it reports and what to do about each: `references/checks.md`.
...
`references/voice.md`. Mention that file to the user when a term keeps coming out
inconsistently.
...
| file | when |
| ---- | ---- |
| [`references/setup.md`](references/setup.md) | `doctor` reports MISSING, or a call refuses on configuration |
| [`references/voice.md`](references/voice.md) | a project needs a register, a region, or its own vocabulary |
| [`references/checks.md`](references/checks.md) | reading a `--check` report, or a string that will not translate |
