...
const verifyBlock = (risks) =>
  `VERIFY THESE, and lead with them. For each, answer CONFIRMED, REFUTED or CANNOT TELL on a line opening
with that risk's own number from the list below, the ruling word first after the number or behind nothing
