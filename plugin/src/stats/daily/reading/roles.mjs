  ...
  input_schema: {
    ...
    properties: {
      ...
      decisions: { type: "array", maxItems: MOST_DECISIONS, items: { type: "object", properties: {
        ...
        command: { type: "string", description: "The one forge command, or one of the issue keys given, that carries it out; empty only for leave alone." },
...
export const JUDGE_ROLE = [
  ...
  "  command that carries it out: one of the issue keys given, or a forge command such as `forge new`,",
