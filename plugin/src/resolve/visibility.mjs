...
export const VERBS = [
  ["issue", "[<uuid|ISS-45>] [--status s] [--search q] [--limit n] [--offset n] [--fields a,b] [--full] [--set f=v... --why W] [--blocks|--relates|--unlink ISS-46 --kind k|--edge id]",
  ...
  ["claim", "<uuid|ISS-45> [--minutes n] [--stopped] [--unheld] [--next <line>] [--pushed] [--review] [--open <line>] [--ready] [--take] [--judged] [--reconciled <sha>] [--recorded] [--landed] [--rebuilt sha --deployment id]",
