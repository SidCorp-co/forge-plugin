...
export const VERBS = [
  ...
  ["issue", "<uuid|ISS-45> [--fields a,b] [--full] [--set f=v --why W]", "one body, or named parts of it",
    "forge_issues", { wraps: { get: "`forge issue`", update: "`forge issue --set`" } }],
  ...
  ["advance", "<uuid|ISS-45> [...]", "the next status, earned by the record or refused with what it owes",
    "forge_issues", { wraps: { transition: "`forge advance`" } }],
