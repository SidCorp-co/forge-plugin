...
export const VERBS = [
  ...
  ["new", "<file.md|@file|-> --title T --kind K [--status S] [--priority P] [--size fix] [--into ISS-45] [--with ISS-45,ISS-46] [--new]",
    "file one, read against the shape its kind needs; --into comments there instead, and needs none",
