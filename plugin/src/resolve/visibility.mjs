...
export const VERBS = [
  ...
  ["claim", "<uuid|ISS-45> [--minutes n] [--stopped] [--unheld] [--next <line>] [--pushed] [--review] [--open <line>] [--ready] [--take] [--judged] [--reconciled <sha>] [--recorded] [--landed] [--rebuilt sha --deployment id|--undeployed]",
