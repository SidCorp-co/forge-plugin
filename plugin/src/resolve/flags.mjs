...
export const pairOf = (given, flag, { refusing = fail } = {}) => {
  const at = given.indexOf("=");
  if (at < 1) refusing(`${flag} takes \`key=value\`, not \`${given}\`.`);
