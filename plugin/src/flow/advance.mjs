...
export const USAGE = [
  ...
  "The rung is a line in the body — `Size: trivial.`, `Size: fix.` or `Size: feature.` — and a body",
  "carrying none is a `feature`; `--owed` names the rung this issue is at and every route off it:",
