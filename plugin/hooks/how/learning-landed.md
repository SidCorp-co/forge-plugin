# learning-landed — the file is already there, and nothing asked

Why: the gate before a write reads shapes, and a shape list is silent on the route nobody thought of.
...
If none of them holds, remove the file. Nothing here undoes the write for you: this fires after it,
and a file kept because deleting it felt wasteful is exactly what the four conditions are against.
