...
How to clear it: re-send the command. The refusal carries every comment on the page the tracker
returns that this session has not been shown, and says when it holds more. An issue with no comments
refuses nothing, and this CLI says so in one line.
