...
import { FRESH_MS, askedAlready, block, how, named, readEvent, settled, touched } from "./_hook.mjs";
...
if (asked.length) {
  block(
    `${asked.map((one) => `\`${one}\``).join(", ")} changed and nothing asked whether ${
      ...
      + `conditions each file meets. If none does, remove it. Reach for Write or Edit next time, where `
