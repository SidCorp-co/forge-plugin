...
import { CONFIG, STANDING, raisedCounts, standingOf, standingProblems } from "../../../src/checks/shapes/standing.mjs";
import { defaultBranch, gitOut, remoteRef } from "../../../../tools/checkout.mjs";
