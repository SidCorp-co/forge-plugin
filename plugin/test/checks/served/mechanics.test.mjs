...
const OWED = [
  ...
  ["skills/issue-flow/default/guide/07-phase-3.md:11", "Both writes take a path and nothing but a path"],
  ["skills/issue-flow/default/guide/07-phase-3.md:18", "the write refuses the compounds it can prove"],
  ["skills/issue-flow/default/guide/07-phase-3.md:33", "`forge record plan` and `forge record criteria` each refuse a file no consult has read"],
  ["skills/issue-flow/default/guide/07-phase-3.md:42", "`forge record plan` and `forge record criteria` each refuse a file no consult has read"],
  ...
  ["skills/issue-flow/screen/guide/07-phase-3.md:39", "`forge record plan` and `forge record criteria` each refuse a file no consult has read"],
  ["skills/issue-flow/screen/guide/07-phase-3.md:48", "`forge record plan` and `forge record criteria` each refuse a file no consult has read"],
