...
/* The four files the script is: itself, the install record reader, the git helpers it shares with the
   gate runner, and the gate's record of its own runs. `check` stands in for the repository's gate,
