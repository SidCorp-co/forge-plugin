...
export const FAMILIES = {
  "an absent payload": () => [
    ...
    ...owed("tested", { plan: "", acceptanceCriteria: CRITERIA }),
    ...owed("released", { plan: "", acceptanceCriteria: CRITERIA }),
  ],
  ...
  "a declared screen change with no attachment": () => owed("tested",
  ...
  "a project that deploys production on its own": () => owed("released",
  ...
  "a landing that moved this change's paths": () => owed("tested",
  ...
  "a verdict older than this reopen's triage": () => owed("tested",
