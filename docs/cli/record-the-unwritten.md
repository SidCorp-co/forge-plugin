# `record` — the four kinds prose was losing

A kind is added when something that mattered was being written somewhere nothing reads it back.
Four of them were, and each names what was going into prose instead.
