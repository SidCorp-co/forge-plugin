...
- **AC-07-9-5** · Rev: 1 · Proof: tools/test/run/release/run-released-version.test.mjs "the release leaves the version it shipped readable on the remote without a fetch"
...
- **AC-07-9-9** · Rev: 1 · Proof: tools/test/run/release/run-released-version.test.mjs "a release that cannot publish its version stops and names the resume that publishes it"
