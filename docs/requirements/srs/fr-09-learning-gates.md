...
- **AC-09-1-1** · Rev: 1 · Proof: plugin/test/learning-gate.test.mjs
...
- **AC-09-1-2** · Rev: 1 · Proof: plugin/test/learning-gate.test.mjs
...
- **AC-09-1-3** · Rev: 1 · Proof: plugin/test/learning-gate.test.mjs
...
- **AC-09-3-1** · Rev: 1 · Proof: plugin/test/learning-landed.test.mjs
  ...
  condition it meets.
- **AC-09-3-2** · Rev: 1 · Proof: plugin/test/learning-landed.test.mjs
  IF a write already passed the stop before it THEN the file SHALL not be asked about again.
- **AC-09-3-3** · Rev: 1 · Proof: plugin/test/learning-landed.test.mjs
