...
- **AC-08-1-1** · Rev: 1 · Proof: plugin/test/gates/bash-guard.test.mjs "the command itself is refused, and the refusal names the rule and a way out"
  WHEN a refused shape is about to run THEN the gate SHALL refuse the command and SHALL name the
  rule and one way out.
- **AC-08-1-2** · Rev: 1 · Proof: plugin/test/gates/bash-guard.test.mjs "a quoted flag is still the flag the rule is about"
...
- **AC-08-1-3** · Rev: 1 · Proof: plugin/test/gates/bash-guard.test.mjs "reading the stash is not reverting it"
...
- **AC-08-2-1** · Rev: 1 · Proof: plugin/test/gates/bash-guard.test.mjs "a rule named in an argument is not a run"
...
- **AC-08-2-2** · Rev: 1 · Proof: plugin/test/gates/bash-guard.test.mjs "a quoted flag is still the flag the rule is about"
  WHEN a flag is quoted THEN the gate SHALL still read it as the flag.
- **AC-08-2-3** · Rev: 1 · Proof: plugin/test/gates/bash-guard.test.mjs "a git aimed at another tree is judged by that tree"
...
- **AC-08-2-4** · Rev: 1 · Proof: plugin/test/gates/bash-guard.test.mjs "a pathspec bounds -A, and only the dot is everything"
