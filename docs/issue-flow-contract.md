...
Its text is `plugin/guides/v1/contract/`, one file per part, and `forge guide contract` prints its
table of contents — one part per line, with the command that prints that part.
